...
public class DrugsWithGradesDTO {
	...
	public DrugsWithGradesDTO(String name, String code, String drugInstanceName, UnspecifiedDTO<ManufacturerDTO> manufacturer,
	...
	public DrugsWithGradesDTO(String name,String producerName, String code, String drugInstanceName, UnspecifiedDTO<ManufacturerDTO> manufacturer,
			FormatDrug drugFormat, double quiantity, String sideEffects, String recommendedAmount,
			List<UnspecifiedDTO<ReplaceDrugDTO>> replacingDrugs, List<UnspecifiedDTO<AllergenDTO>> allergens,
	...
	public DrugsWithGradesDTO(String name, String producerName, String code, String drugInstanceName,
			FormatDrug drugFormat, double quiantity, String sideEffects, String recommendedAmount,
